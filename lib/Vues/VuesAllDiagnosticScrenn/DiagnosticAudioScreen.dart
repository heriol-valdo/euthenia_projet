...
class DiagnosticAudioScreen extends StatefulWidget{
  _DiagnosticAudioScreenState createState() => _DiagnosticAudioScreenState();
}

class _DiagnosticAudioScreenState extends State<DiagnosticAudioScreen>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('DiagnosticAudioScreen',style: StyleText.appbarStyle,),
      ),
      body: Center(
        child: Column(
